<?php
/**
 * Template part for displaying ACF header content in page-home.php
 *
...
<section class="min-h-screen flex flex-col md:flex-row items-center overflow-hidden" data-aos="fade-in" data-aos-delay="500" data-aos-duration="500">
  ...
  <div class="hidden md:block z-0 bg-center bg-cover bg-teal-light pin-t pin-r h-full w-1/4 absolute bg-<?php the_field('theme_color'); ?>" style="background-image: url('<?php echo $background[0]; ?>');" ></div>
  
  <div class="container px-2 sm:px-0 mx-auto relative z-10">
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="w-full md:w-2/3">
        ...
        <div class="flex flex-col sm:flex-row mt-8 pt-8 xl:mt-20 xl:pt-10">
          ...
          <div class="w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="900" data-aos-duration="400">
            <div class="p-4 pt-0 relative leading-normal">
              ...
              <h4 class=""><?php the_field('project_client'); ?></h4>
          ...
          <div class="w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="1000" data-aos-duration="400">
            <div class="p-4 pt-0 relative leading-normal">
              ...
              <h4 class=""><?php the_field('project_challenge'); ?></h4>
